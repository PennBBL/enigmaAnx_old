...
##Get subcortical volume values for ENIGMA Anxiety (this will be used to create histograms for QA)

#Read in data
subjData <- readRDS("/data/jux/BBL/studies/enigmaAnxiety/subjectData/n1110_enigmaAnx_subjData.rds")
volume <- read.csv("/data/joy/BBL/projects/pncReproc2015/freesurfer/stats5_3/aseg.stats/n1601_aseg.stats.volume.csv")

#Merge (this will only keep the 1110 anxiety and TD subjects; to keep all subjects use "all=TRUE")
