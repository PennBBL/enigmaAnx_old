...
#################################
#### Save full n=1120 sample ####
#################################

#Remove the anxiety group variables in the master LandRvolumes.csv file
LandRvolumes_AllAnxTd <- within(subjData_ordered, rm(Agr,Gad,Ocd,Pan,Ptd,Sep,Soc,Sph,Td))

#Save the file (n=1120)
write.csv(LandRvolumes_AllAnxTd,"/data/jux/BBL/projects/enigmaAnxiety/figures/AllAnxTd/LandRvolumes.csv",row.names=FALSE, quote=F)
